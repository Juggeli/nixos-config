  ...
  flake.nixosModules.hyprland =
    ...
    let
      ...
      windowLayoutSwitcher = pkgs.writeShellApplication {
        ...
        text = builtins.readFile ./_assets/window-layout-switcher.sh;
      };
    ...
    in
    {
      ...
      home-manager.users.juggeli = {
        ...
        xdg.configFile = {
          "hypr/hyprpaper.conf".source = ./_assets/hyprpaper.conf;
          "hypr/background.png".source = ./_assets/background.png;
        };
      };
